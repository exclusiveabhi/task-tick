...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showAlert('success', 'Signup Successful', 'Your account has been created!');
      navigate('/login');
    } catch (err) {
      showAlert('error', 'Signup Failed', 'Something went wrong. Please try again!');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        ...
        <div className="mt-4 text-center">
          <Button onClick={handleLoginRedirect} className="w-full" disabled={loading}>
